...
void onSelectNotification(String? payload) async {
  // Navigator.pushNamed(BuildContext, 'detay');
...
class _AnaSayfaState extends State<AnaSayfa> {
  ...
  void initState() {
    ...
    NotificationService()
        .showNotification(1, 'Bob Dylan Quote of the Day', 'Body');
      ...
      child: Scaffold(
        ...
        body: Container(
          child: Stack(
              ...
              fit: StackFit.expand,
              children: <Widget>[
                Image.asset('assets/images/bd.png', fit: BoxFit.cover),
                Container(
                    alignment: Alignment.center,
